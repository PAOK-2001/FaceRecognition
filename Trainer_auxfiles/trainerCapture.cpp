...
void haar_detect(Mat frame, CascadeClassifier target, vector<Rect>& Instances, double scale){
    Mat grayFrame;
    ...
    for (int i = 0; i < Instances.size(); i++){
        ...
        imwrite("/home/paok/Documents/FaceRecognition/trainImages/0"+to_string(total),face);
        total++;
    }
...
int main() {
    ...
    for (;;){
        ...
        haar_detect(frame,faces_haar,facesID,3.8);
